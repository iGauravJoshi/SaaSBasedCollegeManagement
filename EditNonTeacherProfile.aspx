<%@ Page Title="" Language="C#" MasterPageFile="~/Simple.master" AutoEventWireup="true" CodeFile="EditNonTeacherProfile.aspx.cs" Inherits="EditNonTeacherProfile" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <div class="title">
      ...
      <asp:Panel ID="Panel1" runat="server">
              ...
              <asp:TextBox ID="TextBox16" class="form-control" runat="server" 
                  ontextchanged="TextBox16_TextChanged"></asp:TextBox>
              <asp:Label ID="Label23" runat="server" Text="New UserName"></asp:Label>
              <asp:TextBox ID="TextBox17" class="form-control" runat="server" 
