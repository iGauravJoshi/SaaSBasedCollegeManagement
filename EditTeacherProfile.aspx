<%@ Page Title="" Language="C#" MasterPageFile="~/Simple.master" AutoEventWireup="true" CodeFile="EditTeacherProfile.aspx.cs" Inherits="EditTeacherProfile" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <div class="title">
        ...
        <section id="content">
            ...
            <li>
             <asp:LinkButton ID="LinkButton2" runat="server" onclick="LinkButton2_Click">Important Information</asp:LinkButton>
            </li>
            <li>
    ...
    <ContentTemplate>
      ...
      <asp:Panel ID="Panel1" runat="server">
          ...
          <tr>
          <td>
              <asp:Label ID="Label24" runat="server" Text="Photograph"></asp:Label>
          </td>
          <td>
