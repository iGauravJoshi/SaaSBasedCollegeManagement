<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SuperAdminHome.aspx.cs" Inherits="Home" %>
				...
				<div class="container">
					...
					<div class="navbar-collapse collapse">
						<ul class="nav navbar-nav navbar-right">
                            ...
                            <li><a href="Users.aspx" class="scroll-link">View Users</a></li>
                            <li><a href="Login.aspx" class="scroll-link">Log Out</a></li>
						</ul>
					</div>
				</div>
			</div>
		...
		<div id="slides">
			...
			<div class="slider-offers text-center">
				<ul>
					...
					<li>
						<h3>SaaS Based College Management</h3>
						<h4>No need to maintain additional records</h4>
					</li>
					<li>
						<h3>SaaS Based College Management</h3>
						<h4>Many colleges can access through one platform</h4>
					</li>
				</ul>
			</div>
			<!-- SLIDER OFFERS END -->
            ...
            <li class="item nonteacher" style="position: absolute; left: 0px; top: 0px; "> 
		       <figure class="effect-bubba">
					...
					<a href="AdmissionFees.aspx" class="fancybox">Admission Fees</a>						</figcaption>			
                      ...
                      <li class="item tea" style="position: absolute; left: 296px; top: 223px;"> 
			<figure class="effect-bubba">
		 ...
		 <li class="item admin" style="position: absolute; left: 296px; top: 0px; "> 
			...
			<figure class="effect-bubba">
						...
						<figcaption>
							...
							<a href="FeedBackView.aspx" class="fancybox">FeedBack view</a>						</figcaption>			
			  </figure> 
			  </li>
